    ...
    <Section id="experience" className="bg-gray-50 dark:bg-gray-900/50">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary-200 to-primary-300 dark:from-primary-800 dark:to-primary-900"></div>
          
          {experiences.map((exp, index) => (
            <div key={index} className="relative mb-12 ml-4 pl-12 animate-slide-up">
              {/* Timeline dot */}
              <div className="absolute left-0 w-4 h-4 rounded-full bg-primary-500 border-4 border-white dark:border-gray-900 shadow-lg"></div>
              
              <div className="glass-effect rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {exp.technologies.map((tech, idx) => (
                    <span
                      key={idx}
                      className="bg-primary-100 dark:bg-primary-900/30 text-primary-800 dark:text-primary-200 px-3 py-1 rounded-full text-sm font-medium"
                    >
                      {tech}
                    </span>
                  ))}
